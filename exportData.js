  ...
  loadSheetJS(function() {
    ...
    var rows = myRecs.map(function(r) {
      return {
        ...
        '오늘의학습1': r.today1||'', '오늘의학습1이행': COMP[String(r.today1Comp)]||'',
        '오늘의학습2': r.today2||'', '오늘의학습2이행': COMP[String(r.today2Comp)]||'',
        '오늘의학습3': r.today3||'', '오늘의학습3이행': COMP[String(r.today3Comp)]||'',
        '오늘의학습4': r.today4||'', '오늘의학습4이행': COMP[String(r.today4Comp)]||'',
        '오늘의학습5': r.today5||'', '오늘의학습5이행': COMP[String(r.today5Comp)]||'',
      ...
      try {
        ...
        var data = rows.map(function(row) {
          return normalizeRec({
            ...
            today1:        row['오늘의학습1'] || '', today1Comp:   COMP_REV[row['오늘의학습1이행']] !== undefined ? COMP_REV[row['오늘의학습1이행']] : 0,
            today2:        row['오늘의학습2'] || '', today2Comp:   COMP_REV[row['오늘의학습2이행']] !== undefined ? COMP_REV[row['오늘의학습2이행']] : 0,
            today3:        row['오늘의학습3'] || '', today3Comp:   COMP_REV[row['오늘의학습3이행']] !== undefined ? COMP_REV[row['오늘의학습3이행']] : 0,
            today4:        row['오늘의학습4'] || '', today4Comp:   COMP_REV[row['오늘의학습4이행']] !== undefined ? COMP_REV[row['오늘의학습4이행']] : 0,
            today5:        row['오늘의학습5'] || '', today5Comp:   COMP_REV[row['오늘의학습5이행']] !== undefined ? COMP_REV[row['오늘의학습5이행']] : 0,
